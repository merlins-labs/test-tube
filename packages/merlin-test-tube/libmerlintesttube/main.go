...
import (
	...
	// cosmwasm-testing
	"github.com/merlins-labs/test-tube/merlin-test-tube/result"
	"github.com/merlins-labs/test-tube/merlin-test-tube/testenv"
	// merlin
...
func InitTestEnv() uint64 {
	...
	env.App = testenv.SetupMerlinApp()
	...
	env.Ctx = env.App.BaseApp.NewContext(false, tmproto.Header{Height: 0, ChainID: "merlin-1", Time: time.Now().UTC()})
