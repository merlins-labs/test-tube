    ...
    R: Runner<'a>,
{
    ...
    fn_query! {
        pub query_params ["/merlin.tokenfactory.v1beta1.Query/Params"]: QueryParamsRequest => QueryParamsResponse
    }

    fn_query! {
        pub query_denom_authority_metadata ["/merlin.tokenfactory.v1beta1.Query/DenomAuthorityMetadata"]: QueryDenomAuthorityMetadataRequest => QueryDenomAuthorityMetadataResponse
    }

    fn_query! {
        pub query_denoms_from_creator ["/merlin.tokenfactory.v1beta1.Query/DenomsFromCreator"]: QueryDenomsFromCreatorRequest => QueryDenomsFromCreatorResponse
    }
}
...
mod tests {
    ...
    use merlin_std::types::cosmos::bank::v1beta1::QueryBalanceRequest;
    use merlin_std::types::merlin::tokenfactory::v1beta1::{
        MsgBurn, MsgChangeAdmin, MsgCreateDenom, MsgMint, QueryDenomAuthorityMetadataRequest,
        QueryDenomsFromCreatorRequest,
    };

    use crate::{Account, Bank, MerlinTestApp, TokenFactory};
    ...
    fn tokenfactory_integration() {
        ...
        let signer = app
            .init_account(&[Coin::new(2_000_000_000_000, "ufury")])
            .unwrap();
        ...
        // mint
        let coin: merlin_std::types::cosmos::base::v1beta1::Coin =
