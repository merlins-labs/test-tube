use merlin_std::types::merlin::twap::v1beta1;
    ...
    R: Runner<'a>,
{
    ...
    fn_query! {
        pub query_arithmetic_twap ["/merlin.twap.v1beta1.Query/ArithmeticTwap"]: v1beta1::ArithmeticTwapRequest => v1beta1::ArithmeticTwapResponse
    }
    fn_query! {
        pub query_arithmetic_twap_to_now ["/merlin.twap.v1beta1.Query/ArithmeticTwapToNow"]: v1beta1::ArithmeticTwapToNowRequest => v1beta1::ArithmeticTwapToNowResponse
    }

    fn_query! {
        pub query_geometric_twap ["/merlin.twap.v1beta1.Query/GeometricTwap"]: v1beta1::GeometricTwapRequest => v1beta1::GeometricTwapResponse
    }
    fn_query! {
        pub query_geometric_twap_to_now ["/merlin.twap.v1beta1.Query/GeometricTwapToNow"]: v1beta1::GeometricTwapToNowRequest => v1beta1::GeometricTwapToNowResponse
    }
}
...
mod tests {
    ...
    use crate::{Gamm, Module, MerlinTestApp, PoolManager, TokenFactory, Twap};
