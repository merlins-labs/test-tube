...
use merlin_std::shim::Any;
use merlin_std::types::cosmos::base::v1beta1::Coin;
use merlin_std::types::cosmos::gov::v1beta1::{
...
/// It has ability to access to `MerlinTestApp` which is more specific than `Runner`
pub struct GovWithAppAccess<'a> {
    gov: Gov<'a, MerlinTestApp>,
    app: &'a MerlinTestApp,
}

impl<'a> GovWithAppAccess<'a> {
    pub fn new(app: &'a MerlinTestApp) -> Self {
        Self {
            gov: Gov::new(app),
            app,
        }
    ...
    pub fn to_gov(&self) -> &Gov<'a, MerlinTestApp> {
        &self.gov
    }
...
mod tests {
    use merlin_std::types::{
        ...
        merlin::cosmwasmpool::v1beta1::UploadCosmWasmPoolCodeAndWhiteListProposal,
    };
    ...
    fn test_passing_and_execute_proposal() {
        ...
        let proposer = app
            .init_account(&[cosmwasm_std::Coin::new(1000000000000000000, "ufury")])
            .unwrap();
