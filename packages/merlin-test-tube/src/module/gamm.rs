...
use merlin_std::types::merlin::gamm::poolmodels::stableswap::v1beta1::{
    ...
    R: Runner<'a>,
{
    ...
    fn_query! {
        _query_pool ["/merlin.poolmanager.v1beta1.Query/Pool"]: PoolRequest => PoolResponse
    }
        ...
        self.create_balancer_pool(
            MsgCreateBalancerPool {
                ...
                pool_assets: initial_liquidity
                    .iter()
                    .map(|c| PoolAsset {
                        token: Some(merlin_std::types::cosmos::base::v1beta1::Coin {
