...
mod tests {
    ...
    use super::app::MerlinTestApp;
    use cosmwasm_std::{to_binary, BankMsg, Coin, CosmosMsg, Empty, Event, WasmMsg};
    use cw1_whitelist::msg::{ExecuteMsg, InstantiateMsg};
    use merlin_std::types::cosmos::bank::v1beta1::{MsgSendResponse, QueryBalanceRequest};
    use merlin_std::types::cosmwasm::wasm::v1::{
        MsgExecuteContractResponse, MsgInstantiateContractResponse,
    };
    use merlin_std::types::merlin::gamm::poolmodels::balancer::v1beta1::{
        MsgCreateBalancerPool, MsgCreateBalancerPoolResponse,
    };
    use merlin_std::types::merlin::gamm::v1beta1::PoolParams;
    use merlin_std::types::merlin::poolmanager::v1beta1::{PoolRequest, PoolResponse};
    ...
    fn test_query_error_no_route() {
        ...
        let res = app.query::<AdhocRandomQueryRequest, AdhocRandomQueryResponse>(
            "/merlin.random.v1beta1.Query/AdhocRandom",
        ...
        assert_eq!(
            err,
            QueryError {
                msg: "No route found for `/merlin.random.v1beta1.Query/AdhocRandom`".to_string()
            }
        );
    }
    ...
    fn test_query_error_failed_query() {
        ...
        let res = app.query::<PoolRequest, PoolResponse>(
            "/merlin.poolmanager.v1beta1.Query/Pool",
    ...
    fn test_execute_cosmos_msgs() {
        ...
        let signer = app
            .init_account(&[Coin::new(1000000000000, "ufury")])
            .unwrap();
        ...
        assert_eq!(balance.unwrap().denom, "ufury".to_string());
